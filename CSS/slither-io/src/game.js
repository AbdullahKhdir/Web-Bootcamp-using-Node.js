...
Game.prototype = {
    ...
    create: function() {
        ...
        new BotSnake(this.game, 'circle', 400, 0);
        new BotSnake(this.game, 'circle', 800, 0);
        new BotSnake(this.game, 'circle', 0, 10);
        new BotSnake(this.game, 'circle', 50, 80);
        new BotSnake(this.game, 'circle', -10, 300);
        new BotSnake(this.game, 'circle', -90, 250);
        new BotSnake(this.game, 'circle', 800, 100);
        new BotSnake(this.game, 'circle', 70, 70);
          new BotSnake(this.game, 'circle', -900, 500);
          new BotSnake(this.game, 'circle', 150, -520);
          new BotSnake(this.game, 'circle', 1, 20);
